  ...
  <div class="container">
    ...
    <form action="forget.php" method="post">
      <div class="forget">
        ...
        <input type="text" name="username" id="username" placeholder="Enter Your Email" class="Input" />
        <button type="submit" name="mybtn" class="mybtn1">Search</button>
        <a href="login.php" style="font-size: 14px; text-decoration: none">Sign In?</a>
      </div>
    </form>
  </div>
  <footer>
